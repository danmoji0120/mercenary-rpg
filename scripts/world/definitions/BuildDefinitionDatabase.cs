...
public static class BuildDefinitionDatabase
{
    ...
    private static readonly Dictionary<TileBuildType, BuildDefinitionEntry> Entries = new()
    {
        ...
        { TileBuildType.Door, Entry(TileBuildType.Door, "\uBB38", Cost((BaseResourceType.Wood, 2), (BaseResourceType.Metal, 1)), Vector2I.One, true) },
        ...
        { TileBuildType.LuxuryBed, Entry(TileBuildType.LuxuryBed, "\uACE0\uAE09 \uCE68\uB300", Cost((BaseResourceType.Wood, 10), (BaseResourceType.Metal, 2)), new Vector2I(2, 2), false) },
        ...
        { TileBuildType.Lamp, Entry(TileBuildType.Lamp, nameof(TileBuildType.Lamp), Cost((BaseResourceType.Metal, 1)), Vector2I.One, false) },
        ...
        { TileBuildType.ServingCounter, Entry(TileBuildType.ServingCounter, nameof(TileBuildType.ServingCounter), Cost((BaseResourceType.Wood, 4), (BaseResourceType.Metal, 1)), new Vector2I(2, 1), false) },
        ...
        { TileBuildType.Hearth, Entry(TileBuildType.Hearth, nameof(TileBuildType.Hearth), Cost((BaseResourceType.Stone, 8), (BaseResourceType.Metal, 2)), new Vector2I(2, 2), false) },
        ...
        { TileBuildType.LargeStorage, Entry(TileBuildType.LargeStorage, "\uB300\uD615 \uCC3D\uACE0", Cost((BaseResourceType.Wood, 16), (BaseResourceType.Metal, 4)), new Vector2I(3, 2), false) },
        { TileBuildType.MaterialShelf, Entry(TileBuildType.MaterialShelf, "\uC790\uC7AC \uC120\uBC18", Cost((BaseResourceType.Wood, 5)), new Vector2I(2, 1), false) },
        { TileBuildType.WeaponRack, Entry(TileBuildType.WeaponRack, nameof(TileBuildType.WeaponRack), Cost((BaseResourceType.Wood, 4), (BaseResourceType.Metal, 2)), new Vector2I(2, 1), false) },
        { TileBuildType.MedicineShelf, Entry(TileBuildType.MedicineShelf, "\uC57D\uD488 \uC120\uBC18", Cost((BaseResourceType.Wood, 3)), Vector2I.One, false) },
        { TileBuildType.Workbench, Entry(TileBuildType.Workbench, "\uC791\uC5C5\uB300", Cost((BaseResourceType.Wood, 6), (BaseResourceType.Metal, 1)), new Vector2I(2, 1), true) },
        { TileBuildType.LargeWorkbench, Entry(TileBuildType.LargeWorkbench, nameof(TileBuildType.LargeWorkbench), Cost((BaseResourceType.Wood, 12), (BaseResourceType.Metal, 4)), new Vector2I(3, 2), false) },
        { TileBuildType.RepairBench, Entry(TileBuildType.RepairBench, nameof(TileBuildType.RepairBench), Cost((BaseResourceType.Wood, 5), (BaseResourceType.Metal, 3)), new Vector2I(2, 1), false) },
        { TileBuildType.Forge, Entry(TileBuildType.Forge, nameof(TileBuildType.Forge), Cost((BaseResourceType.Stone, 10), (BaseResourceType.Metal, 5)), new Vector2I(2, 2), false) },
        { TileBuildType.AlchemyBench, Entry(TileBuildType.AlchemyBench, nameof(TileBuildType.AlchemyBench), Cost((BaseResourceType.Wood, 4), (BaseResourceType.Stone, 4), (BaseResourceType.Metal, 2)), new Vector2I(2, 1), false) },
        ...
        { TileBuildType.WeaponTrainingRack, Entry(TileBuildType.WeaponTrainingRack, nameof(TileBuildType.WeaponTrainingRack), Cost((BaseResourceType.Wood, 5), (BaseResourceType.Metal, 2)), new Vector2I(2, 1), false) },
        ...
        { TileBuildType.MedicalBed, Entry(TileBuildType.MedicalBed, nameof(TileBuildType.MedicalBed), Cost((BaseResourceType.Wood, 6), (BaseResourceType.Metal, 1)), new Vector2I(1, 2), false) },
        { TileBuildType.LuxuryMedicalBed, Entry(TileBuildType.LuxuryMedicalBed, nameof(TileBuildType.LuxuryMedicalBed), Cost((BaseResourceType.Wood, 10), (BaseResourceType.Metal, 4)), new Vector2I(2, 2), false) },
        { TileBuildType.MedicalTable, Entry(TileBuildType.MedicalTable, nameof(TileBuildType.MedicalTable), Cost((BaseResourceType.Wood, 5), (BaseResourceType.Metal, 2)), new Vector2I(2, 1), false) },
        { TileBuildType.MedicineCabinet, Entry(TileBuildType.MedicineCabinet, nameof(TileBuildType.MedicineCabinet), Cost((BaseResourceType.Wood, 4), (BaseResourceType.Metal, 1)), Vector2I.One, false) },
        ...
        { TileBuildType.TrophyDisplay, Entry(TileBuildType.TrophyDisplay, nameof(TileBuildType.TrophyDisplay), Cost((BaseResourceType.Wood, 5), (BaseResourceType.Metal, 2)), new Vector2I(2, 1), false) },
    ...
    private static BuildStructureDefinition GetFloorDefinition(BuildMaterialType materialType)
    {
        return materialType switch
        {
            ...
            BuildMaterialType.Metal => new BuildStructureDefinition(
                ...
                BuildMaterialType.Metal,
                "\uCCA0\uD310 \uBC14\uB2E5",
                Cost((BaseResourceType.Metal, 1)).Resources,
                120,
                1.5f,
                0.1f,
                0.0f,
    ...
    private static BuildStructureDefinition GetWallDefinition(BuildMaterialType materialType)
    {
        return materialType switch
        {
            ...
            BuildMaterialType.Metal => new BuildStructureDefinition(
                ...
                BuildMaterialType.Metal,
                "\uCCA0\uBCBD",
                Cost((BaseResourceType.Metal, 2)).Resources,
                220,
                1.8f,
                0.2f,
                0.0f,
    ...
    private static BuildStructureDefinition GetDoorDefinition(BuildMaterialType materialType)
    {
        return materialType == BuildMaterialType.Metal
            ? new BuildStructureDefinition(
                ...
                BuildMaterialType.Metal,
                "\uBCF4\uAC15 \uBB38",
                Cost((BaseResourceType.Wood, 2), (BaseResourceType.Metal, 1)).Resources,
                130,
                1.4f,
                0.0f,
                0.0f,
