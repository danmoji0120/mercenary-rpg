...
public enum WorkTypeV3{Gathering,Hauling,Construction,Demolition,Rest,Eating,Sowing,Harvesting}
public enum WorkTargetKindV3{ResourceNode,GroundResourceStack,ConstructionBlueprint,Structure,RestSlot,FarmCell}
