...
public sealed partial class MercenaryWorkSessionV3
{
    ...
    public long SessionRevision{get;}public StockpileSessionV3 Stockpiles{get;}public ResourceReservationRegistryV3 Reservations{get;}=new();public MercenaryWorkDiagnosticsV3 Diagnostics{get;}=new();public int ActiveWorkRequestCount=>_executionsByRequest.Count+_haulingExecutionsByRequest.Count;public int ActiveAssignmentCount=>_assignmentsByMercenary.Count;public int ActiveReservationCount=>Reservations.Count+SourceStackReservations.Count+Stockpiles.CellReservations.Count;
