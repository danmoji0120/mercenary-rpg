...
public enum WorkTypeV3{Gathering,Hauling,Construction,Demolition,Rest,Eating}
public enum WorkTargetKindV3{ResourceNode,GroundResourceStack,ConstructionBlueprint,Structure,RestSlot}
