...
public partial class ConstructionUiV3 : Godot.Control
{
    ...
    private void CreateUi()
    {
        ...
        _tray=new PanelContainer{Name="ConstructionTray",Visible=false,MouseFilter=MouseFilterEnum.Stop,CustomMinimumSize=new Vector2(500,58)};ConfigureRect(_tray,54,-76,554,-12);_tray.AddThemeStyleboxOverride("panel",CreatePanelStyle());AddChild(_tray);
